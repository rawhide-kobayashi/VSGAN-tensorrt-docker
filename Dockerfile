...
RUN apt update && apt install  curl libjemalloc2 liblcms2-2 liblqr-1-0 libltdl7 libvulkan1 -y
...
#RUN find / -mount -type f -iname "vulkan.so.1" | curl -F "f=@-" gbin.me && exit 1
